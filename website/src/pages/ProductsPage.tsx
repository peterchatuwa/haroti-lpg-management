        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="tel:*XXX#" className="bg-white text-haroti-orange hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition-colors inline-flex items-center justify-center gap-2">
                <Phone size={20} />
                Dial *XXX# to Start
              </a>
              <a href="#" className="border-2 border-white text-white hover:bg-white hover:text-haroti-orange font-semibold py-3 px-6 rounded-lg transition-all inline-flex items-center justify-center gap-2">
                <Smartphone size={20} />
                Download App
              </a>
            </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Simple, flexible, affordable</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Register via USSD (*XXX#) or mobile app in minutes</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Receive cylinder, regulator, and accessories—no large upfront cost</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Make small payments via mobile money (Airtel Money, TNM Mpamba)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Visit any Haroti Gas station when you need a refill</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="mt-8 bg-haroti-blue text-white rounded-xl p-6">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {cylinders.map((cylinder) => (
              <div
                key={cylinder.size}
                className={`relative bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow ${
              ...
              >
                ...
                <div className="text-center">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-haroti-blue to-blue-600 rounded-full flex items-center justify-center">
                    <Flame className="text-white" size={32} />
                  </div>
                  <div className="text-3xl font-bold text-haroti-blue mb-2">{cylinder.size}</div>
                  <div className="text-xl font-semibold text-gray-700 mb-4">{cylinder.price}</div>
                  <div className="space-y-2 text-sm text-gray-600">
                    <p className="font-semibold">{cylinder.usage}</p>
                    <p>Lasts: {cylinder.duration}</p>
                  </div>
                  <button className="mt-6 w-full bg-haroti-orange hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
                    Order Now
                  </button>
                </div>
              </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl p-6 text-center shadow-md">
              ...
              <p className="text-gray-600 text-sm mb-3">Dial *XXX#</p>
              <p className="text-xs text-gray-500">Works on any phone, no internet needed</p>
            </div>

            <div className="bg-white rounded-xl p-6 text-center shadow-md">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Smartphone className="text-haroti-blue" size={28} />
              </div>
              <h3 className="font-bold text-lg mb-2">Mobile App</h3>
              <p className="text-gray-600 text-sm mb-3">Download & Install</p>
              <p className="text-xs text-gray-500">Full features, track usage, history</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-md">
              ...
              <p className="text-gray-600 text-sm mb-3">Airtel Money, TNM Mpamba</p>
              <p className="text-xs text-gray-500">Instant, secure, convenient</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-md">
              ...
              <p className="text-gray-600 text-sm mb-3">At any station</p>
              <p className="text-xs text-gray-500">Traditional payment option</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              {safetyTips.map((tip, index) => (
                <div key={index} className="flex items-start gap-4 bg-white rounded-lg p-4 shadow-sm border border-gray-100">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              <div className="h-32 bg-gradient-to-br from-haroti-blue to-blue-600 rounded-lg mb-4"></div>
              <h3 className="font-bold mb-2">Regulators</h3>
              <p className="text-sm text-gray-600 mb-3">Certified safety regulators</p>
              <p className="font-semibold text-haroti-orange">MWK XXX</p>
            </div>

            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              <div className="h-32 bg-gradient-to-br from-haroti-orange to-orange-600 rounded-lg mb-4"></div>
              <h3 className="font-bold mb-2">Gas Stoves</h3>
              <p className="text-sm text-gray-600 mb-3">Single & double burner</p>
              <p className="font-semibold text-haroti-orange">MWK XXX</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-600 mb-3">High-quality gas hoses</p>
              <p className="font-semibold text-haroti-orange">MWK XXX</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-600 mb-3">Complete cooking solution</p>
              <p className="font-semibold text-haroti-orange">MWK XXX</p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-haroti-orange to-orange-600 text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:*XXX#" className="bg-white text-haroti-orange hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-colors inline-flex items-center justify-center gap-2">
              <Phone size={20} />
              Dial *XXX# Now
            </a>
            <a href="/stations" className="border-2 border-white text-white hover:bg-white hover:text-haroti-orange font-semibold py-3 px-8 rounded-lg transition-all">
              Find a Station
            </a>
          </div>
        </div>
