...
export const ImpactPage = () => {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md text-center">
              <Users className="mx-auto text-haroti-blue mb-3" size={40} />
              <div className="text-4xl font-bold text-haroti-blue mb-2">12,450</div>
              <div className="text-gray-600 font-semibold mb-1">Active PAYC Households</div>
              <div className="text-sm text-gray-500">Target: 150,000 by Year 5</div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md text-center">
              ...
              <div className="text-gray-600 font-semibold mb-1">Tonnes CO₂ Avoided</div>
              <div className="text-sm text-gray-500">Annual reduction</div>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-md text-center">
              <Leaf className="mx-auto text-green-600 mb-3" size={40} />
              <div className="text-4xl font-bold text-green-600 mb-2">4,200</div>
              <div className="text-gray-600 font-semibold mb-1">Tonnes Charcoal Saved</div>
              <div className="text-sm text-gray-500">Deforestation prevented</div>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-md text-center">
              <Heart className="mx-auto text-haroti-orange mb-3" size={40} />
              <div className="text-4xl font-bold text-haroti-orange mb-2">245</div>
              <div className="text-gray-600 font-semibold mb-1">Jobs Created</div>
              <div className="text-sm text-gray-500">65% women, 40% youth</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 rounded-xl p-8">
              <TrendingDown className="text-haroti-blue mb-4" size={48} />
              ...
              <div className="font-semibold text-haroti-blue">2,840 tonnes CO₂e avoided annually</div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md">
              <Target className="text-haroti-blue mb-4" size={48} />
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="bg-gradient-to-r from-haroti-blue to-blue-800 text-white rounded-2xl p-12">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-4xl mx-auto">
            {sdgs.map((sdg) => (
              <div key={sdg.number} className="bg-white rounded-lg p-6 text-center shadow-md">
                <div className="w-16 h-16 bg-gradient-to-br from-haroti-blue to-blue-700 rounded-full flex items-center justify-center mx-auto mb-3 text-white font-bold text-2xl">
                  {sdg.number}
                </div>
                <div className="text-sm font-semibold text-gray-700">{sdg.title}</div>
              </div>
            ))}
          </div>
        </div>
