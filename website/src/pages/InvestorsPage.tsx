        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6">
              <TrendingUp className="text-haroti-blue mb-4" size={40} />
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl p-8 shadow-md text-center">
              <div className="text-4xl font-bold text-haroti-blue mb-2">8</div>
              <div className="text-gray-600 font-semibold mb-3">Operating Stations</div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md text-center">
              <div className="text-4xl font-bold text-haroti-blue mb-2">12,450</div>
              <div className="text-gray-600 font-semibold mb-3">Current PAYC Households</div>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md text-center">
              <div className="text-4xl font-bold text-haroti-blue mb-2">2,840</div>
              <div className="text-gray-600 font-semibold mb-3">Tonnes CO₂ Avoided</div>
              <p className="text-sm text-gray-600">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-8 shadow-md border-l-4 border-haroti-orange">
              ...
              <div className="bg-white rounded-xl p-8 shadow-md border-l-4 border-haroti-blue">
              ...
              <div className="bg-white rounded-xl p-8 shadow-md border-l-4 border-haroti-green">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-haroti-blue rounded-full flex items-center justify-center text-white font-bold">
                    40%
                  </div>
                  <div>
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:cfo@harotiholdingslimited.com" className="text-blue-100 hover:text-white transition-colors">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:gm@harotiholdingslimited.com" className="text-blue-100 hover:text-white transition-colors">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg p-6 text-center border-2 border-gray-200">
              <div className="font-bold text-lg text-gray-600">DFI Partners</div>
              <p className="text-sm text-gray-500 mt-2">Development Finance</p>
            </div>

            <div className="bg-white rounded-lg p-6 text-center border-2 border-gray-200">
              <div className="font-bold text-lg text-gray-600">WESM</div>
              <p className="text-sm text-gray-500 mt-2">Carbon Finance</p>
            </div>

            <div className="bg-white rounded-lg p-6 text-center border-2 border-gray-200">
              <div className="font-bold text-lg text-gray-600">MEDF/GETF</div>
              <p className="text-sm text-gray-500 mt-2">Enterprise Development</p>
            </div>

            <div className="bg-white rounded-lg p-6 text-center border-2 border-gray-200">
              <div className="font-bold text-lg text-gray-600">Local Banks</div>
              <p className="text-sm text-gray-500 mt-2">Banking Partners</p>
            </div>
          </div>
        </div>
      </section>
