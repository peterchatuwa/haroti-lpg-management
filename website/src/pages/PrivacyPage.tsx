    ...
    <div className="bg-white">
      <section className="py-16">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-gray-600 mb-8">Last Updated: August 5, 2026</p>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="mt-4 p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-700">Haroti Holdings Limited</p>
                <p className="text-gray-700">Email: privacy@harotiholdingslimited.com</p>
                <p className="text-gray-700">Phone: +265 XXX XXX XXX</p>
              </div>
            </section>
          </div>
        </div>
