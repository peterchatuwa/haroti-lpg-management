...
export const HomePage = () => {
  return (
    <div className="bg-haroti-paper">
      ...
      {/* Stats Section */}
      <section className="py-12 bg-haroti-paper">
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-haroti-muted">Clean Energy Solution</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-haroti-orange mb-2">24/7</div>
              <div className="text-haroti-muted">Customer Support</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-haroti-paper p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            {/* Feature 2 */}
            <div className="bg-haroti-paper p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-haroti-forest/10 rounded-lg flex items-center justify-center mb-4">
            ...
            {/* Feature 5 */}
            <div className="bg-haroti-paper p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-haroti-flame/15 rounded-lg flex items-center justify-center mb-4">
                <TrendingUp className="text-haroti-flame-hot" size={24} />
              </div>
      ...
      <section className="py-16 bg-gradient-to-r from-haroti-orange to-haroti-flame-hot text-white">
        <div className="container-custom text-center">
          ...
          <Link to="/franchise" className="bg-haroti-paper text-haroti-orange hover:bg-haroti-mist font-semibold py-3 px-8 rounded-lg transition-colors inline-flex items-center gap-2">
        ...
        <div className="container-custom">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-haroti-muted">Stay informed about Haroti Gas developments</p>
            </div>
      ...
      <section className="py-16 bg-haroti-forest text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contact" className="bg-haroti-paper text-haroti-forest hover:bg-haroti-mist font-semibold py-3 px-6 rounded-lg transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
