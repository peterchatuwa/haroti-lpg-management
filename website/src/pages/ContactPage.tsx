  ...
  return (
    <div className="bg-haroti-paper">
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-haroti-muted">
                      General: <a href="tel:+265" className="text-haroti-forest hover:text-haroti-orange">+265 XXX XXX XXX</a><br />
                      Emergency: <a href="tel:+265" className="text-haroti-forest hover:text-haroti-orange">+265 XXX XXX XXX</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-haroti-muted">
                      General: <a href="mailto:info@harotiholdingslimited.com" className="text-haroti-forest hover:text-haroti-orange">info@harotiholdingslimited.com</a><br />
                      Support: <a href="mailto:support@harotiholdingslimited.com" className="text-haroti-forest hover:text-haroti-orange">support@harotiholdingslimited.com</a>
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t">
                ...
                <div className="flex gap-3">
                  <a href="#" className="w-10 h-10 bg-haroti-forest hover:bg-haroti-leaf rounded-full flex items-center justify-center text-white transition-colors">
            ...
            {/* Contact Form */}
            <div className="bg-haroti-paper rounded-xl p-8">
      ...
      <section className="h-96 bg-gray-200">
        <div className="h-full flex items-center justify-center text-haroti-muted">
