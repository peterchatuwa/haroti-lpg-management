        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-haroti-muted">
                <p>
                ...
                <p className="font-semibold text-haroti-forest">
                  Our ambitious goal: 150,000 active PAYC households by Year 5.
                </p>
              </div>
            </div>
            <div className="bg-gradient-to-br from-haroti-orange to-haroti-flame-hot rounded-2xl p-12 text-white">
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="text-white/80">Clean Energy Solution</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-haroti-paper rounded-xl p-8 shadow-md">
              <div className="w-16 h-16 bg-haroti-forest/10 rounded-full flex items-center justify-center mb-6 mx-auto">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-haroti-mist to-haroti-paper rounded-xl p-6">
              <Users className="text-haroti-forest mb-4" size={32} />
      ...
      <section className="py-16 bg-haroti-paper">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-haroti-paper rounded-xl overflow-hidden shadow-md">
              <div className="h-64 bg-gradient-to-br from-haroti-forest to-haroti-leaf-bright"></div>
              <div className="p-6">
            ...
            <div className="bg-haroti-paper rounded-xl overflow-hidden shadow-md">
              <div className="h-64 bg-gradient-to-br from-haroti-orange to-haroti-flame-hot"></div>
              <div className="p-6">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-haroti-paper border-2 border-haroti-mist rounded-lg p-6 text-center hover:border-haroti-forest transition-colors">
              ...
              <p className="text-sm text-haroti-muted mt-2">Community Organizations</p>
            </div>
          </div>
        </div>
      </section>
