...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  {
    key: 'sale.discount.override',
    description: 'Approve excess discount',
    category: 'Sales',
  },
  {
    key: 'sale.refund.request',
    description: 'Request refund',
    category: 'Sales',
  },
  {
    key: 'sale.refund.approve',
  ...
  {
    key: 'shift.approve',
    description: 'Approve another user shift',
    category: 'Operations',
  },
  {
    key: 'stock.adjust.request',
    description: 'Request stock adjustment',
    category: 'Inventory',
  },
  {
    key: 'stock.adjust.approve',
    description: 'Approve stock adjustment',
    category: 'Inventory',
  },
  {
    key: 'loss.manage',
    description: 'Investigate and close loss case',
    category: 'Inventory',
  },
  {
  ...
  {
    key: 'finance.journal.manual.create',
    description: 'Create manual journal',
    category: 'Finance',
  },
  {
    key: 'finance.period.close',
    description: 'Close fiscal period',
    category: 'Finance',
  },
  {
    key: 'finance.period.reopen',
    description: 'Reopen fiscal period',
    category: 'Finance',
  },
  {
    key: 'bank.reconcile',
  ...
  {
    key: 'supplier.bank.edit',
    description: 'Edit supplier bank details',
    category: 'Procurement',
  },
  {
    key: 'procurement.approve',
    description: 'Approve procurement within workflow',
    category: 'Procurement',
  },
  {
    key: 'payment.execute',
    description: 'Record or execute supplier payment',
    category: 'Finance',
  },
  {
    key: 'cylinder.override.compliance',
    description: 'Override cylinder compliance block',
    category: 'Safety',
  },
  {
    key: 'incident.manage',
    description: 'Manage safety incident',
    category: 'Safety',
  },
  {
    key: 'audit.export',
  ...
  {
    key: 'staff.invite',
    description: 'Send and resend staff email invites',
    category: 'Staff',
  },
  {
    key: 'security.role.manage',
    description: 'Manage role permission bundles',
    category: 'Security',
  },
];
